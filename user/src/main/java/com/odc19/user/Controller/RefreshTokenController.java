    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try {
                ...
                UserEntity userEntity = userRepository.getUserEntityAndRolesByUserName(userName);
...
//                10 * 60 * 1000 = 10min
                        ...
                        .withClaim("roles", userEntity.getRoleEntities().stream()
                ...
                log.info("Refresh token refreshed: \n" + refresh_token);
