package com.odc19.location.config;
...
import static com.odc19.location.LocationApplication.MODEL_PACKAGE;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.odc19.location.repository.writeRepository"}
)
